...
/*!**********************************!*\
  !*** ./src/app/app.component.ts ***!
  \**********************************/
/*! exports provided: AppComponent, calleValidator */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppComponent", function() { return AppComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calleValidator", function() { return calleValidator; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let AppComponent = class AppComponent {
    ...
    fechaRadioChanged(radio) {
        if (radio === 1) {
            this.stepTwoFormGroupNA.controls['fechaEntregaRadio'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required);
            ...
            this.stepTwoFormGroupNA.controls['fechaEntregaRadio'].updateValueAndValidity();
            this.stepTwoFormGroupNA.controls['fechaEntregaDtp'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required);
            this.stepTwoFormGroupNA.controls['fechaEntregaDtp'].updateValueAndValidity();
        }
    }
    finalizarCompra() {
    ...
    deleteLocation() {
        this.locationSelected = false;
        this.comercioNoAdheridoForm2.controls['calle'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required);
        this.comercioNoAdheridoForm2.controls['calle'].updateValueAndValidity();
        this.comercioNoAdheridoForm2.controls['numero'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required);
        this.comercioNoAdheridoForm2.controls['numero'].updateValueAndValidity();
        this.comercioNoAdheridoForm2.controls['ciudad'].setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required);
        this.comercioNoAdheridoForm2.controls['ciudad'].updateValueAndValidity();
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('stepperNoAd', { static: false })
], AppComponent.prototype, "stepperNoAd", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('comercioAdheridoGroup', { static: false })
], AppComponent.prototype, "comercioAdheridoGroup", void 0);
...
function calleValidator(reg, calle) {
    return (control) => {
